...
QMap<QString, ColumnMap> buildColumnMaps()
{
    ...
    auto add = [&](const QString &table, const QString &field, const QString &title, bool readOnly = false) {
        maps[table].insert(field, ColumnMeta{title, readOnly});
    };

    add(QStringLiteral("personnel_category"), QStringLiteral("category_code"), QStringLiteral("Код категории"), true);
    add(QStringLiteral("personnel_category"), QStringLiteral("name"), QStringLiteral("Наименование"));
    ...
    add(QStringLiteral("product_category"), QStringLiteral("name"), QStringLiteral("Наименование"));

    add(QStringLiteral("work_type"), QStringLiteral("work_type_id"), QStringLiteral("ID вида работ"), true);
    add(QStringLiteral("work_type"), QStringLiteral("name"), QStringLiteral("Наименование"));
    ...
    add(QStringLiteral("laboratory"), QStringLiteral("name"), QStringLiteral("Наименование"));
    ...
    add(QStringLiteral("workshop"), QStringLiteral("name"), QStringLiteral("Наименование"));
    ...
    add(QStringLiteral("section"), QStringLiteral("name"), QStringLiteral("Наименование"));
    ...
    add(QStringLiteral("brigade"), QStringLiteral("name"), QStringLiteral("Наименование"));
    ...
    add(QStringLiteral("employee"), QStringLiteral("full_name"), QStringLiteral("ФИО"));
    ...
    add(QStringLiteral("worker"), QStringLiteral("specialty"), QStringLiteral("Специальность"));
    ...
    add(QStringLiteral("itp"), QStringLiteral("position"), QStringLiteral("Должность"));
    ...
    add(QStringLiteral("product_type"), QStringLiteral("model_name"), QStringLiteral("Модель"));
    ...
    add(QStringLiteral("equipment"), QStringLiteral("name"), QStringLiteral("Наименование"));
