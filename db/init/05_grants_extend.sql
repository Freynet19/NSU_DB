...
GRANT EXECUTE ON PROCEDURE
    proc_hire_worker(VARCHAR, DATE, DATE, INTEGER, VARCHAR, INTEGER, INTEGER),
...
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO role_hr;

-- Production reporting: read data for PREPARE queries and views
GRANT SELECT ON ALL TABLES IN SCHEMA public TO role_production_report;
GRANT SELECT ON ALL SEQUENCES IN SCHEMA public TO role_production_report;
